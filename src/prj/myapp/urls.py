...
from .views import get_inpc_chart_data, calculate_inpc_2 , get_inpc_chart_data,list_inpc_2
...
urlpatterns = [
    path('', welcome_view, name='welcome'),    path("", dashboard_view, name="home"),  # 🏠 Redirige l'accueil vers le dashboard
